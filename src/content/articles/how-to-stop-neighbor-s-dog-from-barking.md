...
description: "Stop a neighbor's dog from barking: talk to the owner first, then use ultrasonic devices, file a noise complaint, or contact animal control."
...
| Method | Estimated cost | Works without owner | Time to results |
|---|---|---|---|
| Direct conversation with owner | Free | No | Days to 1 week |
| Ultrasonic bark deterrent | $25 to $80 | Yes, outdoor dogs only | 1 to 2 weeks |
| White noise machine | $30 to $60 | Yes, for your space | Immediate |
| Written noise complaint (certified mail) | Free | No (needs response) | Days to weeks |
| Animal control or code enforcement report | Free | Depends on municipality | 2 to 6 weeks |
| Small claims court (civil nuisance) | $30 to $100 in filing fees | No | Months |

## What are your legal options for a barking neighbor's dog?
...
Sources: [ASPCA: Barking](https://www.aspca.org/pet-care/dog-care/common-dog-behavior-issues/barking) · [AKC: How to stop a dog from barking](https://www.akc.org/expert-advice/training/how-to-stop-dog-from-barking/)